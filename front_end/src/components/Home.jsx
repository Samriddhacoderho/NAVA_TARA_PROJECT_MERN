...
const Home = () => {
  ...
  return (
    ...
    mode === 'light'
      ...
      <div className={`max-w-4xl w-full rounded-3xl shadow-2xl p-6 sm:p-8 md:p-12 border ${
      mode === 'light'
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <h1 className={`text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold mb-4 sm:mb-6 text-center leading-tight ${
          mode === 'light'
            ? 'text-transparent bg-clip-text bg-gradient-to-r from-indigo-800 to-purple-700'
            : 'text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-400'
        }`}>
            Welcome to Nawatara English School
          </h1>
          
          <p className={`text-base sm:text-lg md:text-xl text-center mb-8 sm:mb-10 max-w-2xl ${
          ...
          {isLoggedIn && (
            <div className="mt-6 w-full sm:w-auto">
              <div className={`relative overflow-hidden px-10 py-5 rounded-2xl shadow-md ${
              mode === 'light'
                ? 'bg-gradient-to-r from-indigo-500/10 to-purple-500/10 border-indigo-100'
                ...
                <p className="text-xl text-red-800 font-medium flex items-center justify-center">
                  ...
                  Welcome back, <span className="font-bold ml-1">{name}</span>
                </p>
              </div>
            </div>
          )}
      ...
      <div className="mt-12 sm:mt-16 grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 max-w-4xl w-full">
        <div className={`rounded-xl p-4 sm:p-6 shadow-lg border flex flex-col items-center ${
        mode === 'light'
        ...
        }`}>Excellence in Education</h3>
          <p className={`text-center ${
          mode === 'light' ? 'text-gray-600' : 'text-gray-400'
        }`}>Providing outstanding academic programs since 1995</p>
        </div>
        ...
        mode === 'light'
          ...
          <p className={`text-center ${
          mode === 'light' ? 'text-gray-600' : 'text-gray-400'
        }`}>Learn from our team of dedicated educators</p>
        </div>
